                        ...
                        <Row className="row-grid justify-content-between">
                            ...
                            <Col md="6">
                                <div className="px-md-5">
                                    ...
                                    <p>
                                        The payment system will help you quickly and efficiently start selling on your website without any problems.
                                    </p>
